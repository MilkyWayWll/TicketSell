...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="306" bgcolor="#FFFFFF"><table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="20" bgcolor="#F0F0F0"><div align="center" class="style7">恭喜<?php echo $_SESSION["username"];?>，您已成功的提交了此订单!详细信息如下:</div></td>
      </tr>
      <tr>
      ...
      <table width="500" height="60" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td bgcolor="#666666"><table width="500" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr bgcolor="#F0F0F0">
                <td width="153" height="20"><div align="center" class="style7">票源名称</div></td>
                <td width="80"><div align="center" class="style7">成人价</div></td>
                <td width="80"><div align="center" class="style7">学生价</div></td>
	  ...
	  for($i=0;$i<count($arraysp)-1;$i++){
		 if($arraysp[$i]!=""){
	     $sql1=mysql_query("select * from tb_piaoyuan where id='".$arraysp[$i]."'",$conn);
	     $info1=mysql_fetch_array($sql1);
		 $total=$total+=$arraysl[$i]*$info1[studentprice];
	  ?>
              <tr bgcolor="#FFFFFF">
                <td height="20"><div align="center"><?php echo $info1[mingcheng];?></div></td>
                <td height="20"><div align="center"><?php echo $info1[price];?></div></td>
                <td height="20"><div align="center"><?php echo $info1[studentprice];?></div></td>
                <td height="20"><div align="center"><?php echo $arraysl[$i];?></div></td>
                <td height="20"><div align="center"><?php echo $arraysl[$i]*$info1[studentprice];?></div></td>
              </tr>
              <?php
	   }
	   }
	 ?>
      ...
      <table width="480" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#FFFFFF">
          <td height="20" align="center"><div align="left" class="style6">&nbsp;下单时间：</div></td>
          <td height="20" colspan="3"><div align="left"><?php echo $info[time];?></div></td>
        </tr>
        <tr bgcolor="#FFFFFF">
